...
namespace hearingapp_otc.iOS.UIClasses
{
    public sealed class ImageHelper
    {
        ...
        public static UIImage ButtonImage(UIColor color, float cornerRadius, UIColor shadowColor, UIEdgeInsets shadowInsets)
        {
            ...
            float totalHeight = EdgeSizeFromCornerRadius(cornerRadius) + (float)shadowInsets.Top + (float)shadowInsets.Bottom;
            float totalWidth = EdgeSizeFromCornerRadius(cornerRadius) + (float)shadowInsets.Left + (float)shadowInsets.Right;
            float topWidth = EdgeSizeFromCornerRadius(cornerRadius);
            float topHeight = EdgeSizeFromCornerRadius(cornerRadius);
            RectangleF topRect = new RectangleF((float)shadowInsets.Left, (float)shadowInsets.Top, topWidth, topHeight);
