...
{
    public sealed class FlatBackButton : UIButton
    {
        ...
        UIColor color = FlatColors.Concrete;
        UIColor shadowColor = FlatColors.Asbestos;
        float cornerRadius = 6f;
        float shadowHeight = 1f;

        public FlatBackButton(int x, int y)
        {
            //Defaults
            this.defaultEdgeInsets = TitleEdgeInsets;

            // All back buttons are the same size
